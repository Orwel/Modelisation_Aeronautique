...
{
    nNinja = mSceneMgr->getRootSceneNode()->createChildSceneNode();
    orbitalCamera = new OrbitCamera(mSceneMgr,nNinja);
    orbitalCamera->setZooming(true);
    mCamera = orbitalCamera->getCamera();
}
